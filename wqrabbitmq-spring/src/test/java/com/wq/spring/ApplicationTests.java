...
import com.wq.spring.entity.Order;
import com.wq.spring.entity.Packaged;
...
public class ApplicationTests {
    ...
    public void testSendJavaMessage() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        String json = mapper.writeValueAsString(order);
        System.err.println("支持Java对象转换: " + json);

        MessageProperties messageProperties = new MessageProperties();
        //这里注意一定要修改contentType为 application/json
        messageProperties.setContentType("application/json");
        messageProperties.getHeaders().put("__TypeId__", "com.wq.spring.entity.Order");//__TypeId__是固定格式
        Message message = new Message(json.getBytes(), messageProperties);
    ...
    public void testSendMappingMessage() throws Exception {
        ...
        System.err.println("testSendMappingMessage（）----order: " + json1);
        ...
        System.err.println("testSendMappingMessage（）----packaged " + json2);
